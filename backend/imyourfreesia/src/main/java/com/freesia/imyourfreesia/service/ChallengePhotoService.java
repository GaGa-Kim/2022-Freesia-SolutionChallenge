...
public class ChallengePhotoService {
    ...
    public List<ChallengePhotoResponseDto> findAllByChallenge(Long challengeId) {
        ...
        List<ChallengePhoto> photoList = challengePhotoRepository.findAllByChallenge(challengeId);
    ...
    public List<ChallengePhotoDto> imageList(Long challengeId) {
        ...
        List<ChallengePhoto> imgList = challengePhotoRepository.findByChallenge(challengeId);
