...
public class EmoticonCountResponseDto {
    @ApiModelProperty(notes = "이모티콘 1 개수")
    private final Long emoticon1;

    @ApiModelProperty(notes = "이모티콘 2 개수")
    private final Long emoticon2;

    @ApiModelProperty(notes = "이모티콘 3 개수")
    private final Long emoticon3;

    @ApiModelProperty(notes = "이모티콘 4 개수")
    private final Long emoticon4;

    @ApiModelProperty(notes = "이모티콘 5 개수")
